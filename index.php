...
<div id="carta-modal">
  <div class="carta-container">
    <!-- <img id="carta-imagen" src="img/carta_2.png" alt="Carta animada" /> -->
     <video id="carta-video" width="300" poster="img/carta_2.jpg" preload="auto" onclick="prueba()">
...
<div id="contenido-principal" class="contenido_principal " style="display: none;"> 
  <!-- Portada -->
  ...
  <section class="presentacion">
    <div class="custom-audio-player controlador">
      ...
      <button id="btnPlayPause" class="btn btn-outline-danger">
    ...
    <div class="nombre_presentacion">
      <h1>SAMANTHA & ALBERTO</h1>
    </div>
    <h2 class="titulo_roboto">¡NOS CASAMOS!</h2>
  ...
  <section class="primera_foto">
    ...
    <div class="primera_imagen">
      <img id="imgAudio" src="img/foto_prueba.jpeg" alt="Imagen juntos" width="70%" height="70%"/>
    </div>
  </section>
            ...
            <div class="flip-card">
              <div class="flip-card-inner">
                <div class="flip-card-front">
                  <img src="https://source.unsplash.com/300x400/?wedding,1" alt="Foto 1" />
  ...
  <section class="codigo_vestimenta">
    ...
    <h2 class="descripcion_sermo">Coctail/Formal</h2>
